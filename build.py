...
PHONE_DISPLAY = '<span class="ph">+968 XXXX XXXX</span>'
PHONE_HREF = "+968XXXXXXXX"
WHATSAPP = "968XXXXXXXX"
HQ = "Muscat, Sultanate of Oman"
  ...
  <div class="wrap">
    <div class="footer-top">
      <div class="footer-brand">
        {LOGO}
        <p>Odoo ERP implementation, customization, integration, training and support for businesses worldwide. Headquartered in {HQ}, delivering remotely and on-site across the GCC, Africa, Europe and Asia.</p>
      ...
      <div class="footer-col">
        ...
        <p><span class="ph">[Street address]</span><br>{HQ}</p>
...
CONTACT_FORM = """<form id="contactForm" class="reveal" novalidate>
    ...
    <div class="wrap contact-grid">
      <div class="contact-info reveal">
        ...
        <div class="contact-detail">
          ...
          <div><div class="label">Head office</div><div class="val"><span class="ph">[Street address]</span>, {HQ}</div></div>
        </div>
        <div class="contact-detail">
